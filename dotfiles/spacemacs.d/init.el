...
values."
  (setq-default
   ...
   '(bbdb bbdb-vcard w3m lispy evil-lispy keyfreq sayid ob-ipython)
...
values."
  ...
  (setq-default
   ...
   dotspacemacs-scratch-mode 'text-mode ;; TODO: revisit
